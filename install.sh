...
sudo apt -y install libavcodec-extra ffmpeg mpv qbittorent timeshift tldr neofetch openssh-server synaptic curl wget nala lshw stacer cpu-x btop lm-sensors preload gamemode xfce4-terminal libreoffice-writer firefox-esr mixxx yuzu obsidian-icon-theme fonts-recommended variety kiwix
...
sudo flatpak install flathub tv.plex.PlexDesktop com.github.tchx84.Flatseal it.mijorus.gearlever -y
