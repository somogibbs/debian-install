...
sudo apt -y install libavcodec-extra ffmpeg mpv qbittorent timeshift tldr neofetch openssh-server synaptic curl git wget nala lshw stacer cpu-x lm-sensors preload gamemode libreoffice-writer blender mixxx pcsxr pcsx2 dolphin-emu yuzu
